...
class Utils {
    ...
    /*Source Later: https://stackoverflow.com/questions/
    * 3736058/java-object-to-byte-and-byte-to-object-converter-for-tokyo-cabinet
    */
    ...
    static void writeContentsAsString(File file, Object... contents) {
        try {
            if (file.isDirectory()) {
                throw
                        new IllegalArgumentException("cannot overwrite directory");
