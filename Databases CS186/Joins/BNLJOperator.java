...
//            if (!leftIterator.hasNext() && !leftRecordIterator.hasNext()) {
//                this.leftRecord = null;
//                this.leftRecordIterator = null;
//            } else if (!leftIterator.hasNext() && leftRecordIterator.hasNext()) {
//                this.leftRecord = leftRecordIterator.next();
...
//            }
        ...
        private void fetchNextRecord() {
            ...
            this.nextRecord = null;
            while (!this.hasNext()) {
            if (!this.rightIterator.hasNext() && !this.rightRecordIterator.hasNext() && !this.leftRecordIterator.hasNext() && !this.leftIterator.hasNext()) {
                throw new NoSuchElementException("No records available");
                ...
                DataBox rightJoinValue = this.rightRecordIterator.next().getValues().get(BNLJOperator.this.getRightColumnIndex());
                if (leftJoinValue.equals(rightJoinValue)) {
                    this.nextRecord = this.joinRecords(this.leftRecord, this.rightRecordIterator.next());
                }
            } else if (this.leftRecordIterator.hasNext() && !this.rightRecordIterator.hasNext()) {
                this.leftRecordIterator.next();
            ...
            } else if (!this.rightIterator.hasNext() && !this.rightRecordIterator.hasNext() && !this.leftRecordIterator.hasNext() && this.leftIterator.hasNext()) {
                fetchNextLeftBlock();
